...
# Advanced filtering is possible e.g. with "jq" using "SES_ALARM_JSON".
...
SES_ALARM_MSG="$4" # alarm message (textual representation)
SES_ALARM_JSON="$5" # alarm JSON (see JSON files for reference)
...
SES_ALARM_MSG="${SES_ALARM_MSG//=/:}" # bugfix for Unraid 7.1.x
SES_ALARM_MSG="${SES_ALARM_MSG//#/:}" # bugfix for Unraid 7.2.x
